...
func main() {
	...
	// 计算统计信息
	avgReadLatency,totalReadAverageLatency := calculateAverage(stats.readLatencies)
	avgWriteLatency, totalWriteAverageLatency := calculateAverage(stats.writeLatencies)
