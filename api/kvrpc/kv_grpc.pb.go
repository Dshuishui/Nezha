...
const (
	...
	KV_ScanRangeInRaft_FullMethodName = "/KV/ScanRangeInRaft"
...
type KVClient interface {
	...
	ScanRangeInRaft(ctx context.Context, in *ScanRangeRequest, opts ...grpc.CallOption) (*ScanRangeResponse, error)
...
func (c *kVClient) ScanRangeInRaft(ctx context.Context, in *ScanRangeRequest, opts ...grpc.CallOption) (*ScanRangeResponse, error) {
	out := new(ScanRangeResponse)
	err := c.cc.Invoke(ctx, KV_ScanRangeInRaft_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type KVServer interface {
	...
	ScanRangeInRaft(context.Context, *ScanRangeRequest) (*ScanRangeResponse, error)
...
func (UnimplementedKVServer) ScanRangeInRaft(context.Context, *ScanRangeRequest) (*ScanRangeResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method ScanRangeInRaft not implemented")
}
...
func _KV_ScanRangeInRaft_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ScanRangeRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(KVServer).ScanRangeInRaft(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: KV_ScanRangeInRaft_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(KVServer).ScanRangeInRaft(ctx, req.(*ScanRangeRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var KV_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "ScanRangeInRaft",
			Handler:    _KV_ScanRangeInRaft_Handler,
		},
		{
